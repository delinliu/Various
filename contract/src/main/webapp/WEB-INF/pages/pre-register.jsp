...
<script src="<%=request.getContextPath()%>/js/pre-register.js"></script>
</head>
<body>
		...
		<div class="row">
			<ul class="nav nav-pills nav-stacked col-md-2" role="tablist"
				...
				<li role="presentation" class="active"><a
					href="<%=request.getContextPath()%>/create-contract">预登记</a></li>
			...
			<div class="text-center col-md-10">
				...
				<div class="text-center" style="margin-top: 30px">
					<button id="create-button" class="btn btn-primary">预 登 记</button> 
				</div>
			</div>
