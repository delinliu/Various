		...
		<div class="text-center">
			...
			<table class=" table-bordered"
				...
				<tr>
					...
					<td class="table-value-width"><input type="radio"
						name="funds-type" value=0>设计费<br> <input type="radio"
						name="funds-type" value=1>外协费<br> <input type="radio"
						name="funds-type" value=2>专用费<br> <input type="radio"
						name="funds-type" value=3>事务费<br> <input type="radio"
						name="funds-type" value=4>专家咨询费</td>
				</tr>
				<tr>
					<td class="table-key-width">合同承办部门</td>
					<td class="table-value-width"><input type="checkbox"
						name="department" value=0>民机系统部<br> <input
						type="checkbox" name="department" value=1>民机管理部<br> <input
						type="checkbox" name="department" value=2>电子部<br> <input
						type="checkbox" name="department" value=3>软件部</td>
						...
						<table class="table-bordered">
							<tr>
								...
								<td colspan=3 class="table-value-width"><input type="radio"
									name="fund-direction" value="">首付款<br> <input
									type="radio" name="fund-direction" value="">进度款<br>
